          ...
          <div className="relative z-10">
            <div className="bg-gradient-to-r bg-hero-gradient px-8 py-6">
              ...
              <p className="text-blue-100 mt-2">
                Join our healthcare network and manage tests securely
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="p-8 space-y-8">
              ...
              <div className="flex justify-end gap-4 pt-6 border-t border-gray-200">
                ...
                <button
                  type="submit"
                  className="px-8 py-3 rounded-lg transition font-medium shadow-lg bg-gradient-to-r bg-hero-gradient text-white hover:from-purple-700 hover:to-blue-700"
                >
