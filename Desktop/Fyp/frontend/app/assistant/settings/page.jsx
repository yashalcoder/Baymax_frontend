...
export default function AssistantSettingsPage() {
  ...
  const handleSave = () => {
    alert("Assistant information updated successfully!")
    setIsEditing(false)
  }
      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="bg-hero-gradient text-white rounded-2xl p-6 shadow-lg">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl md:text-3xl font-bold">Assistant Settings</h1>
            ...
            <div className="flex items-center justify-between">
              <div>
                <CardTitle className="flex items-center gap-2 text-hero">
                  <Phone className="w-5 h-5" /> Assistant Information
                </CardTitle>
                <CardDescription>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setAssistantProfile({ ...assistantProfile, phone: e.target.value })
                  }
                  disabled={!isEditing}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setAssistantProfile({ ...assistantProfile, address: e.target.value })
                  }
                  disabled={!isEditing}
                  className="w-full pl-10 pr-4 py-2 border rounded-lg disabled:bg-gray-100"
                ></textarea>
