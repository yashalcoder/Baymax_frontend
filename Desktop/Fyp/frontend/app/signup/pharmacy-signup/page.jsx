  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire({
        ...
        const redirectPath = roleRedirectMap[data.role] || roleRedirectMap[data.user?.role] || "/pharmacy";
      ...
      <div className="max-w-5xl mx-auto">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden relative">
          ...
          <div className="relative z-10">
            <div className="bg-gradient-to-r from-emerald-600 to-amber-500 px-8 py-6">
              <h1 className="text-3xl font-bold text-white">Pharmacy Registration</h1>
              <p className="text-emerald-100 mt-2">Join our healthcare network and manage prescriptions with ease</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="p-8 space-y-8">
              ...
              <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input name="name" value={formData.name} onChange={handleChange} placeholder="Your pharmacy name" required />
                  </div>
                  <div>
              ...
              <div className="flex justify-end gap-4 pt-6 border-t border-gray-200">
                ...
                <button
                  type="submit"
                  className="px-8 py-3 rounded-lg transition font-medium shadow-lg bg-gradient-to-r from-emerald-600 to-amber-500 text-white hover:from-emerald-700 hover:to-amber-600"
                >
